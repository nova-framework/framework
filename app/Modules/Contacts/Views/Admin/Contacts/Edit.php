...
<div class="box box-default">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" class="form-control" rows="10" style="resize: none;" placeholder="<?= __d('contacts', 'Content'); ?>"><?= Input::old('content', $contact->content); ?></textarea>
        </div>
