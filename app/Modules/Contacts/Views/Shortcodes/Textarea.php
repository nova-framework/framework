...
<div class="form-group<?= $errors->has($name) ? ' has-error' : '' ?>">
    ...
    <div class="col-sm-<?= $shortcode->getParameter('columns') ?: 12; ?>" style="padding: 0;">
        <textarea name="<?= $name; ?>" id="contact-form-<?= $name; ?>" rows="<?= $shortcode->getParameter('rows'); ?>" class="form-control" style="resize: none;" placeholder="<?= $label; ?>"><?= Input::old($name); ?></textarea>
    </div>
    <div class="clearfix"></div>
