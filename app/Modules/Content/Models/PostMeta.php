...
use App\Modules\Content\Models\Collection\MetaCollection;
...
class PostMeta extends Model
{
    ...
    public function taxonomy($primary = null, $where = null)
    {
        ...
        $relation = $this->hasOne('App\Modules\Content\Models\Taxonomy', 'id');
     ...
     *
     * @param  array  $models
     * @return \App\Modules\Content\Models\Collection\MetaCollection
     */
