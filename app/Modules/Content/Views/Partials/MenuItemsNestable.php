    ...
    <li class="dd-item dd3-item" data-id="<?= $item->id; ?>">
        ...
        <div class="dd3-content">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                ...
                <a class="btn btn-sm btn-success" href="#" data-toggle="modal" data-target="#modal-edit-dialog" data-id="<?= $item->id; ?>" title="<?= __d('content', 'Edit this Menu Item'); ?>" role="button"><i class="fa fa-pencil"></i></a>
            </div>
        </div>
