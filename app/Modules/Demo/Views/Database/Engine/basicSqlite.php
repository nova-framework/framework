...
<p>
    ...
    First you need to know the link name you want to use. For example, we will use the 'sqlite' link here and initiate it:
</p>
<pre>$engine = \Nova\Database\Manager::getEngine('sqlite');</pre>
...
function truncate($table); // But doesn't work on SQLite! Use the delete to truncate a table.
