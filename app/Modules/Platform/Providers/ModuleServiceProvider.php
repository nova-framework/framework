...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'App\Modules\Platform\Providers\AuthServiceProvider',
        'App\Modules\Platform\Providers\EventServiceProvider',
        'App\Modules\Platform\Providers\RouteServiceProvider',
    );
