...
Route::post('login',  array('before' => 'guest', 'uses' => 'Authorize@postLogin'));
Route::post('logout', array('before' => 'auth',  'uses' => 'Authorize@logout'));

// The Password Remind.
Route::get( 'password/remind', array('before' => 'guest', 'uses' => 'Authorize@remind'));
Route::post('password/remind', array('before' => 'guest', 'uses' => 'Authorize@postRemind'));

// The Password Reset.
Route::get( 'password/reset/{token}', array('before' => 'guest', 'uses' => 'Authorize@reset'));
Route::post('password/reset',         array('before' => 'guest', 'uses' => 'Authorize@postReset'));
...
// The Heartbeat
Route::post('heartbeat', array('before' => 'auth', 'uses' => 'Heartbeat@update'));

// The Notifications.
Route::get( 'notifications',      array('before' => 'auth', 'uses' => 'Notifications@index'));
Route::post('notifications',      array('before' => 'auth', 'uses' => 'Notifications@update'));
...
Route::group(array('prefix' => 'admin', 'namespace' => 'Admin'), function ()
{
    ...
    Route::post('settings', array('before' => 'auth', 'uses' => 'Settings@store'));
});
