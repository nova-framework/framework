...
<head>
    ...
    Assets::css(array(
        ...
        // Custom CSS
        resource_url('css/style.css', 'Backend'),
    ));
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= site_url('admin/dashboard'); ?>" class="logo">
      ...
      <span class="logo-lg"><?= __d('backend', 'Control Panel'); ?></span>
    </a>
        ...
        <ul class="nav navbar-nav" style="margin-right: 10px;">
          <li <?php if($baseUri == 'admin/messages') echo 'class="active"'; ?>>
            <a href="<?= site_url('admin/messages'); ?>">
              <i class='fa fa-envelope'></i>  <span class="hidden-xs"><?= __d('backend', 'Messages'); ?></span>
          ...
          <li <?php if($baseUri == 'admin/notifications') echo 'class="active"'; ?>>
            <a href="<?= site_url('admin/notifications'); ?>" title="<?= __d('backend', 'Notifications'); ?>">
              <i class='fa fa-bell'></i></span>  <span class="hidden-xs"><?= __d('backend', 'Notifications'); ?></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small><?= __d('backend', 'Member since {0}', $user->present()->memberSince()); ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= site_url('admin/profile'); ?>" class="btn btn-default btn-flat"><?= __d('backend', 'Profile'); ?></a>
                </div>
                <div class="pull-right">
                  <a href="<?= site_url('logout'); ?>" class="btn btn-default btn-flat"><?= __d('backend', 'Sign out'); ?></a>
                </div>
              </li>
            </ul>
          </li>
