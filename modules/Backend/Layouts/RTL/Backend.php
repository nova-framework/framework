...
<head>
    ...
    Assets::css(array(
        // Bootstrap 3.3.5
        resource_url('css/bootstrap-rtl.min.css', 'Backend'),
        // Font Awesome
        ...
        // Theme style
        resource_url('css/AdminLTE-rtl.min.css', 'Backend'),
        // AdminLTE Skins
        vendor_url('dist/css/skins/_all-skins.min.css', 'almasaeed2010/adminlte'),
        // Custom CSS
        resource_url('css/style-rtl.css', 'Backend'),
    ));
...
Assets::js(array(
    // Bootstrap 3.3.5
    resource_url('js/bootstrap-rtl.min.js', 'Backend'),
    // AdminLTE App
