<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= __d('contacts', 'Manage the Field Intems'); ?></li>
    </ol>
</section>
...
<form id="create-group-form" class="form-horizontal" action="<?= site_url('admin/contacts/field-groups/' .$contact->id .'/items'); ?>" method='POST' role="form">
