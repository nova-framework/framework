...
Route::group(array('prefix' => 'admin', 'namespace' => 'Modules\Messages\Http\Controllers\Admin'), function()
{
    ...
    Route::post('messages',                  array('middleware' => 'auth|csrf', 'uses' => 'Messages@store'));
    Route::get( 'messages/{threadId}',       array('middleware' => 'auth',      'uses' => 'Messages@show'));
    //Route::post('messages/{postId}/destroy', array('middleware' => 'auth|csrf', 'uses' => 'Messages@destroy'));

    Route::post('messages/{threadId}', array('middleware' => 'auth|csrf', 'uses' => 'Messages@reply'));
});
