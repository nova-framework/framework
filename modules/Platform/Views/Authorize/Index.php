<section class="content-header">
    <h2 style="margin-top: 25px; padding-bottom: 10px; border-bottom: 1px solid #FFF;"><?= __d('platform', 'User Login'); ?></h2>
</section>
    ...
    <div style="margin-top: 50px" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-primary" >
            <div class="panel-heading">
                <div class="panel-title"><?= __d('platform', 'Login to <b>{0}</b>', Config::get('app.name')); ?></div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group" style="margin-top: 20px; margin-left: 10px;">
                    <p><label><input name="remember" type="checkbox"> <?= __d('platform', 'Remember me'); ?></label></p>
                </div>
                <hr>
                ...
                <div class="form-group" style="margin-top: 22px;">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <input type="submit" name="submit" class="btn btn-success col-sm-8" value="<?= __d('platform', 'Login'); ?>">
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <a href="<?= site_url('authorize'); ?>" class="btn btn-link pull-right"><?= __d('platform', 'Get an <b>One-Time Login</b> link'); ?></a>
                    </div>
                </div>
