...
class Profile extends BaseController
{
    ...
    public function show($id)
    {
        try {
            ...
            return Redirect::to('admin/users/profile')->with('danger', __d('contacts', 'Field Item not found: #{0}', $id));
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $url = site_url('admin/users/profile', $contact->id);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        */
        ...
        return Redirect::to('admin/users/profile')
            ->with('success', __d('contacts', 'The Field Item was successfully deleted.'));
    }
}
