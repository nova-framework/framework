...
";
        ...
        $tableBuilder->setName('dummy3');

        $tableBuilder->addField('name', 'varchar(50)');
        $tableBuilder->addField('description', 'text');
        $tableBuilder->addField('addedDate', 'TIMESTAMP', false, tableBuilder::CURRENT_TIMESTAMP);
