...
return array (
  ...
  'Please enter your e-mail address to be sent a link to reset your password.' => 'Пожалуйста, введите свой адрес email для отправки ссылки для сброса пароля.',
  'Profile' => 'Профиль',
  'Profile Picture' => 'Картинка профиля',
  'Receiver' => 'Получатель',
  'Register to <b>{0}</b>' => 'Регистрация <b>{0}</b>',
  ...
  'Reset your password for <b>{0}</b>' => 'Сброс пароля на <b>{0}</b>',
  'Role' => 'Роль',
  'Roles' => 'Роли',
  'SMTP' => 'SMTP',
  'Save' => 'Сохранить',
  ...
  'The Role <b>{0}</b> cannot be deleted because it is assigned to <b>{1}</b> User(s).' => 'Роль <b>{0}</b> невозможно удалить, т.к. она назначена <b>{1}</b> пользователю(-ям)',
