...
$router->get( 'login',  array('middleware' => 'guest', 'uses' => 'Authorize@getLogin'));
...
$router->get( 'register', array('middleware' => 'guest', 'uses' => 'Registrar@getRegister'));
$router->post('register', array('middleware' => 'guest', 'uses' => 'Registrar@postRegister'));
