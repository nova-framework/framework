<div class='btn-group pull-right' role='group' aria-label='...'>
    ...
    <a class='btn btn-sm btn-danger' href='#' data-toggle='modal' data-target='#modal_delete_role' data-id='<?= $role->id ?>' title='<?= __d('backend', 'Delete this Role'); ?>' role='button'><i class='fa fa-remove'></i></a>
</div>
