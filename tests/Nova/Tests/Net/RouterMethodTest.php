...
class RouterMethodTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBasicGet()
    {
        ...
        \Nova\Net\Router::register('get', 'test/get/basic/1', function () use (&$current_1) {
            $current_1 = true;
        });
    ...
    public function testBasicQueryGet()
    {
        ...
        // Add route with the new method
        \Nova\Net\Router::register('get', 'test/get/query/1', function () use (&$current_query, &$current_query_test) {
    ...
    public function testParameterGet()
    {
        ...
        // Add testing routes
        \Nova\Net\Router::register('GET', 'test/get/param/any/(:any)', function ($param) use (&$current_1) {
            $current_1 = $param;
        });

        // Add testing routes
        \Nova\Net\Router::register('GET', 'test/get/param/num/(:num)', function ($param) use (&$current_2) {
            $current_2 = $param;
        });
    ...
    public function testBasicPost()
    {
        ...
        // Add testing routes
        \Nova\Net\Router::register('POST', 'test/post/1', function () use (&$current_method, &$current_method_match, &$current_url) {
    ...
    public function testBasicPut()
    {
        ...
        // Add testing routes
        \Nova\Net\Router::register('PUT', 'test/put/1', function () use (&$current_method, &$current_method_match, &$current_url) {
            $current_url = \Nova\Net\Url::detectUri();
            $current_method = \Nova\Net\Request::getMethod();
    ...
    public function testBasicDelete()
    {
        ...
        // Add testing routes
        \Nova\Net\Router::register('DELETE', 'test/delete/1', function () use (&$current_method, &$current_method_match, &$current_url) {
            $current_url = \Nova\Net\Url::detectUri();
            $current_method = \Nova\Net\Request::getMethod();
