      ...
      <div class="container">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li <?php if($path == 'profile') echo 'class="active"'; ?>>
